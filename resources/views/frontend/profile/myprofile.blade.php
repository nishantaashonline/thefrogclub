        ...
        <div class="my-profile-inner-box">
            <div class="profile-cover-image">
                <a href="#">
                    ...
                    @else
                    <img src="{{asset('assets/frontend/images/profile/'.auth()->user()->coverphoto)}}" alt="image">
                    @endif

                </a>
                <a href="#demo-modal" class="edit-cover-btn">Edit Cover</a>
            </div>
                ...
                <div class="inner-info-box d-flex justify-content-between align-items-center">
                    <div class="info-image">
                        <a href="#">
                            ...
                            <img src="{{asset('assets/images/frontend/images/user.png')}}" alt="image" style="max-width: 250px">
                            @else
                            <img src="{{asset('assets/frontend/images/profile/'.auth()->user()->profile_img)}}" alt="image">
                            @endif
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="friends-tab" data-bs-toggle="tab" href="#friends" role="tab"
                                aria-controls="friends">Friends</a>
                        </li>
                        ...
                        <div class="news-feed-area">
                            ...
                            <div class="news-feed news-feed-post">
                                ...
                                <div class="post-body">
                                    ...
                                    <form class="post-footer">
                                        <div class="footer-image">
                                            <a href="#"><img src="assets/images/user/user-15.jpg"
                                                    class="rounded-circle" alt="image"></a>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="message" class="form-control" placeholder="Write a comment..."></textarea>
                            ...
                            <div class="news-feed news-feed-post">
                                <div class="post-header d-flex justify-content-between align-items-center">
                                    <div class="image">
                                        <a href="my-profile.html"><img src="assets/images/user/user-5.jpg"
                                                class="rounded-circle" alt="image"></a>
                                    </div>
                                    <div class="info ms-3">
                                ...
                                <div class="post-body">
                                    ...
                                    <div class="post-comment-list">
                                        <div class="comment-list">
                                            <div class="comment-image">
                                                <a href="my-profile.html"><img src="assets/images/user/user-21.jpg"
                                                        class="rounded-circle" alt="image"></a>
                                            </div>
                                            <div class="comment-info">
                                                <h3>
                                        ...
                                        <div class="comment-list">
                                            <div class="comment-image">
                                                <a href="my-profile.html"><img src="assets/images/user/user-22.jpg"
                                                        class="rounded-circle" alt="image"></a>
                                            </div>
                                            <div class="comment-info">
                                                <h3>
                                        ...
                                        <div class="comment-list">
                                            <div class="comment-image">
                                                <a href="my-profile.html"><img src="assets/images/user/user-24.jpg"
                                                        class="rounded-circle" alt="image"></a>
                                            </div>
                                            <div class="comment-info">
                                                <h3>
                                    ...
                                    <form class="post-footer">
                                        <div class="footer-image">
                                            <a href="#"><img src="assets/images/user/user-19.jpg"
                                                    class="rounded-circle" alt="image"></a>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="message" class="form-control" placeholder="Write a comment..."></textarea>
                            ...
                            <div class="news-feed news-feed-post">
                                ...
                                <div class="post-body">
                                    ...
                                    <form class="post-footer">
                                        <div class="footer-image">
                                            <a href="#"><img src="assets/images/user/user-22.jpg"
                                                    class="rounded-circle" alt="image"></a>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="message" class="form-control" placeholder="Write a comment..."></textarea>
                    ...
                    <div class="col-lg-3 col-md-12">
                        <aside class="widget-area">
                            ...
                            <div class="widget widget-explore-events">
                                ...
                                <article class="item">
                                    <a href="#"><img src="assets/images/explore-events/explore-1.jpg"
                                            alt="image"></a>
                                </article>
                                <article class="item">
                                    <a href="#"><img src="assets/images/explore-events/explore-2.jpg"
                                            alt="image"></a>
                                </article>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-12">
                        <div class="about-personal-information">
                            ...
                            <ul class="information-list">
                                ...
                                <li>
                                    <span>Birthday:</span> {{ $data->dob }}
                                </li>

                                <li>
                                    <span>Birthplace:</span> {{ $data->city }}, {{ $data->state }} ,{{ $data->country }}
                                </li>
                                <li>
                                    <span>Phone:</span> <a href="tel:{{ $data->phone }}">{{ $data->phone }}</a>
                                </li>
                                <li>
                                    <span>Gender:</span>
                                    @if ($data->gender == 'm')
                                ...
                                @if ($data->married != null)
                                    <li>
                                        <span>Relationship Status:</span>
                                        @if ($data->married == '1')
                                            Married
                                        @elseif ($data->married == '0')
                                            Unmarried
                                        @endif
                                    </li>
                                @endif
                                    ...
                                    <div class="dropdown">
                                        <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false"><i
                                                class="flaticon-menu"></i></button>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item d-flex align-items-center" href="{{route('edit.about')}}"><i
                                                        class="flaticon-edit"></i> Edit Information</a></li>
...
{{-- add edution --}}
            ...
            <div class="tab-pane fade" id="friends" role="tabpanel">
                <div class="friends-inner-box-style d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="all-friends-tab" data-bs-toggle="tab" href="#all-friends"
                                role="tab" aria-controls="all-friends">All Friends</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" id="recently-added-tab" data-bs-toggle="tab" href="#recently-added"
                                role="tab" aria-controls="recently-added">Recently Added</a>
                        </li>
                    </ul>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="all-photos-tab" data-bs-toggle="tab" href="#all-photos"
                                role="tab" aria-controls="all-photos">All Photos</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" id="photos-albums-tab" data-bs-toggle="tab" href="#photos-albums"
                                role="tab" aria-controls="photos-albums">Photos Albums</a>
                        </li>
                    </ul>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="all-photos" role="tabpanel">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-photos-card">
                                    <a href=""><img src="assets/images/photos/photos-10.jpg"
                                            alt="image"></a>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-photos-card">
                                    <a href=""><img src="assets/images/photos/photos-11.jpg"
                                            alt="image"></a>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-photos-card">
                                    <a href=""><img src="assets/images/photos/photos-12.jpg"
                                            alt="image"></a>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-photos-card">
                                    <a href=""><img src="assets/images/photos/photos-13.jpg"
                                            alt="image"></a>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-photos-card">
                                    <a href=""><img src="assets/images/photos/photos-14.jpg"
                                            alt="image"></a>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-photos-card">
                                    <a href=""><img src="assets/images/photos/photos-15.jpg"
                                            alt="image"></a>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-photos-card">
                                    <a href=""><img src="assets/images/photos/photos-16.jpg"
                                            alt="image"></a>
    ...
    <div id="demo-modal" class="modal">
        <div class="modal__content">
            ...
            <form action="{{route('update.coverphoto')}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="file" class="custom-file-input form-control" id="inputGroupFile01"
                                aria-describedby="inputGroupFileAddon01" name="coverphoto">
                        </div>
                    </div>
